...
<body>
    ...
    <div id="pcoded" class="pcoded">
                                ...
                                <div class="main-search morphsearch-search">
                                    <div class="input-group">
                                        <span class="input-group-addon search-close"><i
                                                class="fa-duotone fa-solid fa-xmark"></i></span>
                                        <input type="text" class="form-control" placeholder="Enter Keyword">
                                        <span class="input-group-addon search-btn"><i
                                                class="fa-duotone fa-solid fa-magnifying-glass"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a href="https://eskooly.com">
                            <img class="img-fluid m-l-30" id="headerimg" style="max-height:45px;"
                                src="assets/images/logo1.png" alt="eSkooly-Logo" />
                        </a>
                    ...
                    <div class="navbar-container container-fluid">
                        <ul class="nav-left">
                            <li>
                                <div class="sidebar_toggle"><a href="javascript:void(0)"><i
                                            class="fa-duotone fa-solid fa-ellipsis"></i></a></div>
                            </li>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <form action="requestmanager.php" method="post">
                                            ...
                                            <button type="submit" name="dashboard"
                                                class="input-group-addon search-btn1"><i
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification" style="float:right;">
                                <a href="#!">
                                    <img src="logos/1740212976.png" style="width:40px; height:40px;"
                                        class="img-radius">
                ...
                <div class="pcoded-wrapper">
                    ...
                    <nav class="pcoded-navbar" style="background:#f6f7fb;">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu" id="generalsettings">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">General
                                            Settings</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="schoolinfo">
                                            <a href="schoolinfo.php">
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Institute Profile</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="feeparticulars">
                                            <a href="feeparticulars.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs">Fees
                                                    Particulars</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="discounttype">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    ...
                                                    style="opacity:0.6;">Fees Structure <i
                                        ...
                                        <li class=" " id="discounttype">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Discount Type <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="challan">
                                            <a href="bankdetails.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs">Accounts For Fees
                                                    Invoice</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="rules">
                                            <a href="rules.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Rules & Regulations</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="grading">
                                            <a href="grading.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs">Marks Grading</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="themesettings">
                                            <a href="themesettings.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Theme & Language</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        ...
                                        <li class=" " id="account">
                                            <a href="account.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Account Settings</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="logout.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs">Log out</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu" id="classes">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"
                                            data-i18n="nav.basic-components.main">Classes</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" " id="newclass">
                                            <a href="addnewclass.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs">New Class</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li class="pcoded-hasmenu" id="subjects">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"
                                            data-i18n="nav.basic-components.main">Subjects</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="showsubjects">
                                            <a href="showsubjects.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Classes With Subjects</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="assignsubjects">
                                            <a href="subjects.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Assign Subjects</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" " id="searchadmissionletter">
                                            <a href="stdregal.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Admission Letter</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="idcard">
                                            <a href="studentcards.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Student ID Cards</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="printinfo">
                                            <a href="printinfo.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Print Basic List</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="slogin">
                                            <a href="studentLogin.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Manage Login</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="promotions">
                                            <a href="promotions.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Promote Students</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="pcoded-hasmenu" id="employees">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"
                                            data-i18n="nav.basic-components.main">Employees</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" " id="eidcard">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Staff ID Cards <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="jobletter">
                                            <a href="empregal.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Job
                                                    Letter</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu" id="accounts">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"
                                            data-i18n="nav.basic-components.main">Accounts</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="heads">
                                            <a href="chartofaccounts.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Chart Of Account</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        ...
                                        <li class=" " id="statement">
                                            <a href="balance.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Account Statement</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="getchallan">
                                            <a href="getchallan.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Generate Fees Invoice</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="submitfee">
                                            <a href="submitfees.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Collect Fees</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="feeslip">
                                            <a href="stdregfs.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Fees
                                                    Paid Slip</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        ...
                                        <li class=" " id="feereport">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Fees Report <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="deletefee">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Delete Fees <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="submitsalary">
                                            <a href="submitsalary.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Pay
                                                    Salary</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="salaryslip">
                                            <a href="empregfs.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Salary Paid Slip</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="salarysheet">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Salary Sheet <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        ...
                                        <li class=" " id="salaryrecord">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Salary Report <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu" id="attandance">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"
                                            data-i18n="nav.basic-components.main">Attendance</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="studentsattandance">
                                            <a href="markatt.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Students Attendance</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="employeesattandance">
                                            <a href="chooseeattend.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Employees Attendance</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="classwise">
                                            <a href="attreport.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Class wise Report</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="studentattendancereport">
                                            <a href="allatt.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Students Attendance
                                                    Report</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="employeeattendancereport">
                                            <a href="alleatt.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Employees Attendance
                                                    Report</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li class="pcoded-hasmenu" id="timetable">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"
                                            data-i18n="nav.basic-components.main">Timetable</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" " id="periods">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Time Periods <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="classrooms">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Class Rooms <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li class="pcoded-hasmenu" id="behaviour">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Behaviour &
                                            Skills</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" " id="rateskills">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Rate Skills <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="observations">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Observations <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li class="pcoded-hasmenu" id="pos">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Online Store
                                            & POS</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" " id="tax">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Product Tax <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        ...
                                        <li class=" " id="orders">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">All Orders <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li class=" " id="whatsapp">
                                    <a href="#" data-toggle="tooltip"
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main"
                                            style="opacity:0.6;"> WhatsApp</span>
                                ...
                                <li class=" " id="messages">
                                    <a href="MessageBox.php">
                                        ...
                                        <span class="pcoded-mtext"
                                            data-i18n="nav.form-components.main">Messaging</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="pcoded-hasmenu" id="sms">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">SMS
                                            Services</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="smsgateway">
                                            <a href="smsSettings.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Free
                                                    SMS Gateway</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="brandedsms">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Branded SMS <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="smstemplates">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">SMS Templates <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li class=" " id="liveclass">
                                    <a href="liveclass.php">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Live
                                            Class</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu" id="questionpaper">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Question
                                            Paper</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" " id="questionbank">
                                            <a href="#" data-toggle="tooltip"
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"
                                                    style="opacity:0.6;">Question Bank <i
                                                        class="fa fa-lock m-orange f-right"></i></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li class="pcoded-hasmenu" id="exams">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"
                                            data-i18n="nav.basic-components.main">Exams</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="createexam">
                                            <a href="addexam.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Create New Exam</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="editexamdetail">
                                            <a href="editexamdetail.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Edit or delete</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="addexammarks">
                                            <a href="selectexam.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Add / update Exam
                                                    Marks</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        ...
                                        <li class=" " id="resultcard">
                                            <a href="searchexamresult.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Result Card</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li class="pcoded-hasmenu" id="tests">
                                    <a href="javascript:void(0)">
                                        <span class="pcoded-micon"><i class="ti-files"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Class
                                            Tests</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="createtest">
                                            <a href="classtest.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Create New Test</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="testreport">
                                            <a href="alltest.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Test Result</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li class="pcoded-hasmenu" id="reports">
                                    <a href="javascript:void(0)">
                                        <span class="pcoded-micon"><i class="ti-files"></i></span>
                                        <span class="pcoded-mtext"
                                            data-i18n="nav.basic-components.main">Reports</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="reportcard">
                                            <a href="reportcardfor.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Students report Card</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="report1">
                                            <a href="report1.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Students info report</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="report2">
                                            <a href="report2.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Parents info report</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="report3">
                                ...
                                <li class="pcoded-hasmenu" id="certificates">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"
                                            data-i18n="nav.basic-components.main">Certificates</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" " id="lc">
                                            <a href="leavecertificate.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Leave Certificate</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" " id="cc">
                                            <a href="charactercertificate.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Character
                                                    Certificate</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                            ...
                            <div style="margin:0 auto;width:90%;text-align:center;background:white;"
                                class="m-round p-10">
                                <i class="ti-search f-20 bold"></i><br style="margin:2px;padding:0px;">
                                <strong>Need More Advance ?</strong><br>
                                <span style="font-size:12px;">Check our PRO version. An ultimate education management
                                    ERP with all advance features.</span><br>
                                <a href="https://pro.eskooly.com" target="_blank"><button
                                        class="btn btn-sm m-t-10 bg-m-orange m-white m-round">Try Demo</button></a>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <!-- Row start -->
                                        <div class="row">
                                            <div class="col-12 p-10 f-14"
                                                style="border-radius:10px;background:#fff;box-shadow:0px 0px 1px 0px gray;">
                                                <strong
                                                    style="border-right:1px solid #777;padding-right:10px;margin-right:10px;">Attendance</strong>
                                                <i class="ti-home"></i> - Add/update Attendance
                                            </div>
                                        </div>
                                        <div class="row" style="">
                                            <div class="col-2"></div>
                                            <div class="col-lg-8 m-t-30"
                                                ...
                                                <h6 class="text-center m-t-10"><span
                                                        ...
                                                        taken</span> <span class="m-dblue f-16 m-r-10">Employees
                                                    </span> <span class="text-secondary f-12">26 Feb, 2025</span></h6>
                                                <h4 class="text-center m-t-20" style="line-height:20px;"> Update
                                                    ...
                                                    <div class="bg-m-blue1"
                                                        ...
                                                        style="display:inline-block;font-weight:100;">Present</span>
                                                    ...
                                                    <div class="bg-m-orange m-l-10"
                                                        ...
                                                        style="display:inline-block;font-weight:100;">Absent</span>
                                                </h4>

                                                <form action="sql.php" method="post" class=" m-t-10"
                                                    id="myform">
                                                    <table class="table center" style="margin:0 auto;"
                                                        cellpadding="10px">
                                                        ...
                                                        <tbody class="text-secondary">
                                                            ...
                                                            <tr>
                                                                <td><input type="number" name="id0"
                                                                        value="150098" id="hide1"></td>
                                                                <td><input type="text" name="n0"
                                                                        value="Sabita Bhabi" id="hide"></td>
                                                                <td id="desktop1"><input type="text"
                                                                        name="fn0" value=""
                                                                        id="hide"></td>
                                                                <td id="desktop1"><input type="text"
                                                                        name="et0" value="Teacher"
                                                                        id="hide"></td>
                                                                <td style="width:100px;">

                                                                    <input type="radio" name="s0"
                                                                        value="P" id="P0"
                                                                        class="present" checked><label
                                                                        for="P0">P</label>
                                                                    <input type="radio" name="s0"
                                                                        value="L" id="L0"
                                                                        class="leave"><label
                                                            ...
                                                            <tr>
                                                                <td><input type="number" name="id1"
                                                                        value="140518" id="hide1"></td>
                                                                <td><input type="text" name="n1"
                                                                        value="Ramita kc" id="hide"></td>
                                                                <td id="desktop1"><input type="text"
                                                                        name="fn1" value=""
                                                                        id="hide"></td>
                                                                <td id="desktop1"><input type="text"
                                                                        name="et1" value="Teacher"
                                                                        id="hide"></td>
                                                                <td style="width:100px;">
                                                    ...
                                                    <h5 class="w-100 text-center p-20"><button type="submit"
                                                            name="eattsheetup" style="border-radius:25px;"
                                                            id="submitBtn"
                                                            class="submit btn bg-c-yellow text-dark"><i
                                                                class="ti-reload"></i> Update</button></h5>
                                                </form>
                                            </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header  bg-m-blue1 m-white" style="padding-top:2px;padding-bottom:2px;">
                        ...
                        <span class="modal-title text-center" style="display:inline;"><img
                                src="assets/images/icon1.png" style="max-width:20px;"> eSkooly</span>
                        <button type="button" class="close" style="display:inline;font-size:22px;"
                            data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body" style="padding-top:5px;padding-bottom:5px;">
                        <strong><i class="ti-alert"></i> Alert</strong>
                        <p class="f-12">No Class has been found. Please add at leaset one Class before to access
                            this feature.</p>
                    </div>
                    <div class="modal-footer" style="padding-top:5px;padding-bottom:10px;">
                        <a href="addnewclass.php"><button type="button"
                                class="btn btn-sm bg-gradient-success m-white f-10">Ok, Add Class</button></a>
        ...
        <div class="modal fade" id="addsubjects" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding-top:5px;padding-bottom:5px;">
                        <strong><i class="ti-alert"></i> Alert</strong>
                        <p class="f-12">No Subject Found against this class. Please assign subjects to this class
                            first!</p>
                    </div>
                    <div class="modal-footer" style="padding-top:5px;padding-bottom:10px;">
                        <a href="subjects.php"><button type="button"
                                class="btn btn-sm bg-gradient-success m-white f-10">Ok, Add Subjects</button></a>
        ...
        <div class="modal fade" id="addteacher" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="padding-top:5px;padding-bottom:10px;">
                        <a href="addnewteacher.php"><button type="button"
                                class="btn btn-sm bg-gradient-success m-white f-10">Ok, Add Teacher</button></a>
        ...
        <div class="modal fade" id="addchaptersm" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding-top:5px;padding-bottom:5px;">
                        <strong><i class="ti-alert"></i> Alert</strong>
                        <p class="f-12">No Chapter Found against this class and subject. Please add chapters first!
                        </p>
                    </div>
                    <div class="modal-footer" style="padding-top:5px;padding-bottom:10px;">
                        <a href="addchapters.php"><button type="button"
                                class="btn btn-sm bg-gradient-success m-white f-10">Ok, Add Chapters</button></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="padding-top:5px;padding-bottom:10px;">
                        <a href="admission.php"><button type="button"
                                class="btn btn-sm bg-gradient-success m-white f-10">Ok, Add Student</button></a>
        ...
        <script>
            ...
            document.getElementById("employeesattandance").classList.add('active');
            document.getElementById("attandance").classList.add('active');
            document.getElementById("attandance").classList.add('pcoded-trigger');
            //----------end-----------------

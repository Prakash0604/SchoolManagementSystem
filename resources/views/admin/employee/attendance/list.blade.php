            ...
            <div class="page-body">
                ...
                <div class="row mb-4">
                    <div class="col-12 p-10 f-14" style="border-radius:10px;background:#fff;box-shadow:0px 0px 1px 0px gray;">
                        ...
                        <i class="ti-home"></i> - All Employee Attendance
                    </div>
                </div>
                ...
                <div class="row" style="margin-top:20px;">
                    ...
                    <div class="col-md-3">
                        <div class="m-div p-t-0 p-b-0">
                            <span class="m-label bg-gradient-blue m-white" style="margin-top:-9px;z-index:1001; padding-right:30px">Employee*</span>

...
$(document).on("change","#starting_date,#ending_date,#employee_id,#filter_status",function(){
    getData();
 })

$(document).off("click","#addEmployeeAttendanceBtn").on("click","#addEmployeeAttendanceBtn",function(){
...
$(document).off("submit","#storeAttendance").on("submit","#storeAttendance",function(e){
    e.preventDefault();
...
$(document).off("change","#attendance_date").on("change","#attendance_date",function(){
    let date=$(this).val();
    console.log(date);
    $.ajax({
        type:"get",
